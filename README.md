...
The RBI ATM and card statistics used in this project are sourced from the Kaggle dataset:  
[**India ATM-Card and Digital Payments Statistics**](https://www.kaggle.com/datasets/bhanageviraj/india-atm-card-and-digital-payments-statistics) by Bhanage Viraj.

The dataset contains monthly ATM/card statistics from 65 Indian banks across all categories (Public, Private, Foreign, Payment, and Small Finance Banks), covering metrics such as ATM counts, cards outstanding, transaction volumes/values, PoS terminals, QR codes, and digital payment share.
