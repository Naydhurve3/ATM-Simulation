...
from banking_core.data_visualization import DataVisualization
from atm_cli.atm_simulator import ATMSimulator
from atm_cli.user_manager import UserManager
from atm_cli.user_analytics import UserAnalytics
from atm_cli.demo_manager import DemoManager
...
from banking_core.models.lstm_forecaster import LSTMForecaster
from banking_core.models.real_time_fraud_detector import RealTimeFraudDetector
from banking_core.models.investment_recommender import InvestmentRecommender
from banking_core.models.atm_replenishment import ATMReplenishmentOptimizer
from banking_core.models.rfm_segmenter import RFMSegmenter
from banking_core.models.savings_optimizer import SavingsGoalOptimizer
from banking_core.models.sentiment_analyzer import SentimentAnalyzer
...

    ...
    def _launch_dashboard(self):
        ...
        web_entry = repo_root / "v3_web" / "run_web.py"
        console.print("[yellow]Launching Web App (v3) in browser...[/yellow]")
        subprocess.Popen([sys.executable, str(web_entry)], cwd=str(repo_root / "v3_web"))
        Prompt.ask("[yellow]Web app running at http://127.0.0.1:5000 . Press Enter to return[/yellow]", default="")
    ...
    def _channel_breakdown(self):
        ...
        channel_label = f"— {bank}" if bank else "— All Banks"
        table = Table(title=f"Channel Breakdown {channel_label}", box=box.ROUNDED)
