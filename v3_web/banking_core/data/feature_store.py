...
class FeatureStore:
    ...
    def _register_default_features(self):
        defaults = [
            ...
            ("txn_fraud_count", "user", "Number of flagged fraud transactions",
             "COALESCE(SUM(CASE WHEN t.is_fraud=TRUE THEN 1 ELSE 0 END),0)", "INTEGER"),
    ...
    def compute_user_features(self, user_ids=None):
        ...
        feature_cols = [
            ...
            "COALESCE(SUM(CASE WHEN t.is_fraud=TRUE THEN 1 ELSE 0 END),0) as txn_fraud_count",
    ...
    def compute_bank_features(self):
        from banking_core.data.db_manager import db as dbm
