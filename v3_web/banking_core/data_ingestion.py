...
class DataIngestion:
    ...
    def save_to_sqlite(self):
        from banking_core.data.postgres_adapter import is_enabled, write_dataframe
        if is_enabled():
            write_dataframe(self.df, "atm_card_stats")
