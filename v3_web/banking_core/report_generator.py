...
import fitz
from banking_core.utils import OUTPUTS_REPORTS, OUTPUTS_CHARTS, format_currency, format_number, get_scenario_timestamp
...
class ReportGenerator:
    ...
    def _passbook_ml_insights(self, pdf, accounts):
        ...
        try:
            ...
            pass
        try:
            from banking_core.models.spending_forecaster import SpendingForecaster
