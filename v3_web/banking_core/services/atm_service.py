...
from banking_core.repositories.account_repository import AccountRepository
from banking_core.repositories.transaction_repository import TransactionRepository
...
class ATMService:
            ...
            "transactions": [
                {
                    ...
                    "balance_after": t.get("balance_after") or 0,
                }
                for t in txns
            ],
        }
    ...
    def _get_denominations(self, amount: float) -> dict:
        from banking_core.utils import calculate_cash_denominations
